...
namespace MSP2050.Scripts
{
	public abstract class APolicyLogic : MonoBehaviour
	{
		...
		{ }
		public abstract void GetRequiredApproval(APolicyPlanData a_planData, Plan a_plan, Dictionary<int, EPlanApprovalState> a_approvalStates, Dictionary<int, List<IApprovalReason>> a_approvalReasons, ref EApprovalType a_requiredApprovalLevel);
