...
namespace UnityEngine.UI
{
	...
	[AddComponentMenu("UI/ScalableSlicedImage", 11)]
	public class ScalableSlicedImage : MaskableGraphic, ILayoutElement, ICanvasRaycastFilter
	{
		[SerializeField]
		...
		[SerializeField] private Vector4 borderDisplaySize;
		...
		private void GenerateSlicedSprite(VertexHelper toFill)
		{
			...
			Vector4 border = GetAdjustedBorders(borderDisplaySize / pixelsPerUnit, rect);
		...
		private Vector2 MapCoordinate(Vector2 local, Rect rect)
		{
			...
			Vector4 adjustedBorder = GetAdjustedBorders(borderDisplaySize / pixelsPerUnit, rect);
			...
			for (int i = 0; i < 2; i++)
			{
				...
				local[i] = Mathf.Lerp(borderDisplaySize[i], spriteRect.size[i] - borderDisplaySize[i + 2], lerp);
			}
