...
namespace MSP2050.Scripts
{
	public class PlanManager : MonoBehaviour
	{
		...
		[HideInInspector] public FishingDistributionDelta initialFishingValues { get; private set; }
		...
		private void LoadInitialFishingValues()
		{
			NetworkForm form = new NetworkForm();
			ServerCommunication.Instance.DoRequest<List<FishingObject>>(Server.GetInitialFishingValues(), form, LoadInitialFishingValuesCallback);
		}

		private void LoadInitialFishingValuesCallback(List<FishingObject> fishing)
		{
